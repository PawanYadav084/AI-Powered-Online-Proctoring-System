...
//         const NGROK_URL = 'https://unrredisposing-dendriform-fermina.ngrok-free.dev/process_frame';;; // Replace with your Ngrok URL
...
(function() {
    ...
    setInterval(() => {
        ...
        // --- YEH RAHI UPDATED LINE ---
        // Ab yeh aapke local python server se connect karega
        //const SERVER_URL = 'http://127.0.0.1:5001/process_frame'; 
        const SERVER_URL = 'https://my-ai-proctor.onrender.com/process_frame';

        fetch(SERVER_URL, { // <-- Yahan NGROK_URL ki jagah SERVER_URL istemal kiya hai
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ image_data: imageData }),
        })
